    ...
    <section id="contact" className="section" style={{ background: 'var(--color-surface)' }}>
      <div className="container" style={{ textAlign: 'center', maxWidth: 560 }}>
        ...
        <p style={{ color: 'var(--color-text-muted)', marginBottom: 28 }}>
          Open to co-op opportunities in mechatronics and robotics. Reach out by email or connect on LinkedIn.
        </p>
        <div style={{ display: 'flex', gap: 14, justifyContent: 'center' }}>
          <a href="mailto:your.email@uwaterloo.ca" className="btn btn-primary">Email Me</a>
